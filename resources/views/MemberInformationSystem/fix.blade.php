                        ...
                        <form action="/user/{{Auth::user()->id}}" method='post'>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Birthday</td>
                                        <td><input type="date" name="birthday" value="{{$users[0]->birthday}}"></td>
                                    </tr>
                                    <tr>
                                        <td>Phone</td>
                                        <td><input type="number" name="phont" value="{{$users[0]->phont}}"></td>
                                    </tr>
                                    <tr>
                                        <td>address</td>
                                        <td><input type="text" name="address" value="{{$users[0]->address}}"></td>
                                    </tr>
                                </tbody>
                            </table>
