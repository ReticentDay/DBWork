			...
			<div class="single">
				<div class="col-md-9 top-in-single">
					<div class="col-md-5 single-top">
						<img class="col-md-12" src="{{$product_info[0]->photo}}" alt="" width='350' />
					</div>
					<div class="col-md-7 single-top-in">
						<div class="single-para">
							<h4>{{$product_info[0]->product_name}}</h4>
							<div class="para-grid">
								<span  class="add-to">$ {{$product_info[0]->price}} NTW</span>
								<div class="clearfix"></div>
							 </div>
							<div class="available">
                                <form action="/shop/add" method="post">
                                    ...
                                    <input type='submit' href="#" class="hvr-shutter-in-vertical cart-to" value='Add to Cart'>
                                </form>
							</div><br>
